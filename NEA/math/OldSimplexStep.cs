...
namespace NEA.math
{
    public struct OldSimplexStep
    {
        ...
        public (SimplexState state, OldSimplexStep? next, string info) Next()
        // Return same step if ended
        {
            ...
            if (isCompleted())
            {
                OldSimplexStep step = (OldSimplexStep)MemberwiseClone();
            ...
            if (stage == SimplexStage.TWO_STAGE_MIN || stage == SimplexStage.TWO_STAGE_MAX)
            {
                ...
                if (isCompleted)
                {
                    ...
                    OldSimplexStep new_step_art = new OldSimplexStep();
            ...
            OldSimplexStep new_step = new OldSimplexStep();
            new_step.vars = vars;
